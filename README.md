# [Gluón ⚛] Módulo de Tiempo 
## ⏳ (Núcleo determinista) 
## Para motores de simulación 🖥 multiplataforma y desacoplado del Motor. 

# Documento técnico.[ ⚙ 🔧]

# 1. Propósito del módulo. 🚀 

El módulo Tiempo es responsable de proporcionar al motor un control preciso, estable y seguro del tiempo de simulacion.
...
Si vas a programar con este núcleo de tiempo...
